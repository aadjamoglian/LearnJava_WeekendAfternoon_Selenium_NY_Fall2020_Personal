...
//		System.out.println("Burger name is " + nameOfBurger);
	...
	public Burger(String nameOfBurger, String topping,char size) {
		...
		System.out.println("");
		System.out.println("Burger name is " + burgerName + " Burger size " + burgerSize + " Topping is " + topping);
	}
	
	public Burger(String nameOfBurger, String topping,char size, double totalValue, boolean isBurgerAvailable) {
		String burgerName = this.nameOfBurger = nameOfBurger;
		char burgerSize = this.size = size;
		String burgerTopping = this.topping = topping;
		...
		System.out.println("");
		System.out.println("Burger name is " + burgerName + " Burger size " + burgerSize + " Topping is " + topping + " Burger price " + burgerPrice + " Burger Quantity " + burgerQuantity + " Total value " + burgerTotalValue + " Burger Availability " + burgerAvailabilityCheck);
	}
	...
	public static void main(String[] args) {
		...
		Burger khusbu = new Burger("Wendys", "Toamato", 'S', 670.39, true);
